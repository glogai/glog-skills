...
This repository contains reusable **agent skills** for Glog workflows in this workspace. Each skill lives in its own directory, is defined by a `SKILL.md` file, and is intended to be installed and invoked by name in tools such as Codex and Claude Code.
